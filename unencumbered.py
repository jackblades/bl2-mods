...
swapGrimFearless = skillA("GD_Assassin_Skills.SkillTree.Branch_Cunning", {
    "Tiers[1].Skills[0]": "SkillDefinition'GD_Assassin_Skills.Bloodshed.Grim" }
 )
...
fearless = skillA("GD_Assassin_Skills.Cunning.Fearless", {
    "SkillEffectDefinitions": [
        ...
        attr(
            AttributeToModify="AttributeDefinition'D_Attributes.GameplayAttributes.BaseArmor'",
            EffectTarget="TARGET_Self",
            ModifierType="MT_PreAdd",
            BaseModifierValue=kValue(0.50)),
        attr(
            AttributeToModify="AttributeDefinition'D_Attributes.ActiveSkillCooldownResource.ActiveSkillCooldownConsumptionRate'",
            EffectTarget="TARGET_Self",
            ModifierType="MT_Scale",
            BaseModifierValue=kValue(1.50)),
        attr(
            AttributeToModify="AttributeDefinition'D_Attributes.GameplayAttributes.FootSpeed'",
            EffectTarget="TARGET_Self",
            ModifierType="MT_Scale",
            BaseModifierValue=kValue(0.25)),
    ] + [
        attr(
            AttributeToModify="AttributeDefinition'D_Attributes.DamageTypeModifers.InstigatedShockDamageModifier'",
            EffectTarget="TARGET_Self",
            ModifierType="MT_Scale",
            BaseModifierValue=kValue(4)),
        attr(
        ...
        attr(
            ...
            EffectTarget="TARGET_None",
            ModifierType="MT_PreAdd",
            BaseModifierValue=value(0, "AttributeDefinition'D_Attributes.WeaponType.Weapon_Is_Pistol'", None, 1)),
        attr(
            AttributeToModify="AttributeDefinition'D_Attributes.Weapon.WeaponDamage'",
            EffectTarget="TARGET_Self",
            ModifierType="MT_PreAdd",
            BaseModifierValue=value(-25, "AttributeDefinition'D_Attributes.WeaponType.Weapon_Is_Shotgun'", None, 1)),
        attr(
            AttributeToModify="AttributeDefinition'D_Attributes.Weapon.WeaponDamage'",
            EffectTarget="TARGET_Self",
            ModifierType="MT_PreAdd",
            BaseModifierValue=value(-25, "AttributeDefinition'D_Attributes.WeaponType.Weapon_Is_Sniper_Rifle'", None, 1)),
        attr(
            AttributeToModify="AttributeDefinition'D_Attributes.Weapon.WeaponDamage'",
            EffectTarget="TARGET_Self",
            ModifierType="MT_PreAdd",
            BaseModifierValue=value(-25, "AttributeDefinition'D_Attributes.WeaponType.Weapon_Is_Rocket_Launcher'", None, 1)),
    ]
})
...
ffylDeception = skillA("GD_Assassin_Skills.ActionSkill.Skill_Deception", {
    "SkillConstraints": "((bApplyConstraintOnActivatation=False,bApplyConstraintWhileActive=False,bApplyConstraintWhilePaused=False,OnFailure=SKILL_Deactivated,Evaluator=WeaponActionAvailableExpressionEvaluator'GD_Assassin_Skills.ActionSkill.Skill_Deception:WeaponActionAvailableExpressionEvaluator_0',EvaluatorDefinitions=),(bApplyConstraintOnActivatation=True,bApplyConstraintWhileActive=True,bApplyConstraintWhilePaused=True,OnFailure=SKILL_Deactivated,Evaluator=None,EvaluatorDefinitions=(SkillExpressionEvaluatorDefinition'GD_PlayerShared.SkillConstraints.SkillConstraint_OnFootOrRidingInBack')))"
})

ffylDeception2 = skillA("GD_Input.Contexts.InputContext_Injured", {
    "InputActions": "(InputActionDefinition'GD_Input.Actions.InputAction_ActionSkill')"
})
...
- no weapons equipped
    - -150% weapon damage
- shield should have love thumper like slag nova 
        or antagnist style slag since theres no good slag nova

BLW, LTW, FEARLESS, Unforseen, Iron Hand, Resurgence

- ffyl
    - action skill


- fast deception, +150% cooldown
- +150% shock damage (CL, SF, Quasar)
- +25% move speed
- +50% cooldown rate
- in decepti0n
    - +150% melee dmg
...
# ConstantAttributeValueResolver'GD_Assassin_Skills.Misc.Cooldown_Deception:ConstantAttributeValueResolver_0'
# InventoryAttributeDefinition'GD_Assassin_Skills.Misc.Cooldown_Deception'


# attr(
#     AttributeToModify="AttributeDefinition'D_Attributes.DamageSourceModifiers.InstigatedMeleeDamageModifier'",
#     EffectTarget="TARGET_Self",
#     ModifierType="MT_PreAdd",
#     BaseModifierValue=kValue(0.5)),
# attr(
#     AttributeToModify="AttributeDefinition'D_Attributes.DamageSourceModifiers.InstigatedMeleeDamageModifier'",
#     EffectTarget="TARGET_Self",
#     ModifierType="MT_PreAdd",
#     BaseModifierValue=value(0, "DesignerAttributeDefinition'GD_Assassin_Skills.Misc.Att_ActionSkillIsActive'", None, 1.50)),
# attr(
#     AttributeToModify="AttributeDefinition'D_Attributes.DamageEnhancementModifiers.PlayerConvertDamageToHealingPercent'",
#     EffectTarget="TARGET_Self",
#     ModifierType="MT_PreAdd",
#     BaseModifierValue=kValue(0.30)),
# attr(
#     AttributeToModify="AttributeDefinition'D_Attributes.DamageEnhancementModifiers.PlayerConvertDamageToHealingPercent'",
#     EffectTarget="TARGET_Self",
#     ModifierType="MT_PreAdd",
#     BaseModifierValue=value(0, "DesignerAttributeDefinition'GD_Assassin_Skills.Misc.Att_ActionSkillIsActive'", None, -0.30)),